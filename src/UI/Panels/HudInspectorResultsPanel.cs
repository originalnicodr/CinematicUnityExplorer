...
{
    public class HudInspectorResultsPanel : UEPanel
    {
        public override UIManager.Panels PanelType => UIManager.Panels.HudInspectorResults;

        public override string Name => "Hud Inspector Results";
        ...
        public HudInspectorResultsPanel(UIBase owner) : base(owner)
        {
        }
        ...
        private List<GameObject> GetEntries() => HudInspector.LastHitObjects;

        private bool ShouldDisplayCell(object cell, string filter) => true;

        private void OnCellClicked(int index)
        {
            if (index >= HudInspector.LastHitObjects.Count)
                return;

            InspectorManager.Inspect(HudInspector.LastHitObjects[index]);
        }
        ...
        private void SetCell(ButtonCell cell, int index)
        {
            ...
            GameObject obj = HudInspector.LastHitObjects[index];
