...
{
    public class EnemyInspectorResultsPanel : UEPanel
    {
        public override UIManager.Panels PanelType => UIManager.Panels.EnemyInspectorResults;

        public override string Name => "Enemy Inspector Results";
        ...
        public EnemyInspectorResultsPanel(UIBase owner) : base(owner)
        {
        }
        ...
        private List<GameObject> GetEntries() => EnemyInspector.LastHitObjects;

        private bool ShouldDisplayCell(object cell, string filter) => true;

        private void OnCellClicked(int index)
        {
            if (index >= EnemyInspector.LastHitObjects.Count)
                return;

            InspectorManager.Inspect(EnemyInspector.LastHitObjects[index]);
        }
        ...
        private void SetCell(ButtonCell cell, int index)
        {
            ...
            GameObject obj = EnemyInspector.LastHitObjects[index];
